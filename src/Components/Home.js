const Home = () => (
  <div className="my-16 mx-auto text-center">
    <p className="m-10">
      ...
      Kaiken Ajotaito-kursseihin liittyvän löydät puolestaan osiosta <a className="underline text-blue-600 hover:text-blue-800 visited:text-purple-600" href="/Ajoharjoittelu">Kurssit</a>.<br />
      <a className="underline text-blue-600 hover:text-blue-800 visited:text-purple-600" href="/Ajoharjoittelu">Tapahtumat</a>-osiosta puolestaan löytyy kauden 2023 tapahtumat.
    </p>
